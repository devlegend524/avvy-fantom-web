  ...
  render() {
    const wallets = [
      ...
      },
      {
        ...
        logo: this.renderStaticImage('images/vendor/coinbase.png', 'Coinbase Wallet'),
        connect: () => {
      ...
      {
        name: 'WalletConnect',
        logo: this.renderStaticImage('images/vendor/walletconnect.svg', 'WalletConnect'),
