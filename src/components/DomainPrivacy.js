    ...
    return (
      <>
        <div className='grid gap-2 grid-cols-1 md:grid-cols-2 w-full'>
          <div onClick={() => this.props.onCheck(false)} className={`cursor-pointer bg-gray-100 dark:bg-gray-800 p-4 rounded-xl border-2 ${error ? 'border-red-500' : this.props.isEnhancedPrivacy ? 'border-gray-100 dark:border-gray-800' : 'border-gray-700 dark:border-white'}`}>
            <div className='font-bold flex items-center justify-between'><div className=''>{'Standard Privacy'}</div><div className={this.props.isEnhancedPrivacy ? 'hidden' : ''}><CheckCircleIcon className='w-6 text-gray-700 dark:text-white' /></div></div>
          ...
          <div onClick={() => this.props.onCheck(true)} className={`cursor-pointer bg-gray-100 dark:bg-gray-800 p-4 rounded-xl border-2 ${error ? 'border-red-500' : this.props.isEnhancedPrivacy ? 'border-gray-700 dark:border-white' : 'border-gray-100 dark:border-gray-800'}`}>
            <div className='font-bold flex items-center justify-between'><div className=''>{'Enhanced Privacy'}</div><div className={this.props.isEnhancedPrivacy ? '' : 'hidden'}><CheckCircleIcon className='w-6 text-gray-700 dark:text-white' /></div></div>
            <ul className='list-disc pl-4 mt-4 text-sm'>
