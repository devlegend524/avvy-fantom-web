...
const mapStateToProps = (state) => ({
  error: services.user.selectors.setPasswordError(state),
  loading: services.user.selectors.setPasswordLoading(state),
  result: services.user.selectors.setPasswordResult(state),
})

const mapDispatchToProps = (dispatch) => ({
  setPassword: (token, password, passwordConfirm) => dispatch(services.user.actions.setPassword(token, password, passwordConfirm)),
  reset: () => dispatch(services.user.actions.resetSetPassword()),
})
